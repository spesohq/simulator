<div class="h-screen flex flex-col font-ubuntu bg-gray-100">
    <div class="flex-shrink bg-purple-800">
        <div class="flex w-full max-w-screen-lg mx-auto flex-col h-full">
            <div class="text-lg flex-none pt-6 pb-8">
                        ...
                        <div class="space-y-4 pt-12 pb-16">
                            <div class="flex items-center">
                                ...
                                <div x-data="{ url: '' }" class="inline-block relative w-full max-w-sm">
                                    <input x-bind:class="{ 'bg-gray-100 text-blue-800 opacity-100': url !== '' }" x-model="url" class="form-input sim-input pl-5 pr-12 bg-white" wire:model="url" type="url" name="url" placeholder="eg. https://a924d784.ngrok.io" autocomplete="off" />
                            ...
                            <div class="flex items-center">
                                ...
                                <div x-data="{ method: '', hide: true }" class="inline-block relative w-full max-w-sm z-30">
                                    ...
                                    <input x-bind:class="{ 'pl-5': method === '', 'pl-16 bg-gray-100 text-blue-800 opacity-100': method !== '' }" x-model="method" x-on:click="hide = false" class="form-input sim-select pr-12 cursor-pointer bg-white" wire:model="method" type="text" name="method" placeholder="Select request method" autocomplete="off" readonly />
                                    <div class="absolute inset-y-0 right-0 flex items-center">
                            ...
                            <div class="flex items-center">
                                ...
                                <div x-data="{ network: '', hide: true }" class="inline-block relative w-full max-w-sm z-20">
                                    ...
                                    <input x-bind:class="{ 'pl-5': network === '', 'pl-16 bg-gray-100 text-blue-800 opacity-100': network !== '' }" x-model="network" x-on:click="hide = false" class="form-input sim-select pr-12 cursor-pointer bg-white" wire:model="network" type="text" name="network" placeholder="Select network operator" autocomplete="off" readonly />
                                    <div class="absolute inset-y-0 right-0 flex items-center">
                                        <svg class="w-6 h-6 text-ash-dark mr-5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                    </div>
                                    <div x-bind:class="{ 'hidden': hide === true }" x-on:click.away="hide = true" class="absolute bg-gray-100 inset-x-0 rounded-b">
                            ...
                            <div class="flex items-center">
                                ...
                                <div x-data="{ phoneNumber: '' }" class="inline-block relative w-full max-w-sm">
                                    <input x-bind:class="{ 'bg-gray-100 text-blue-800 opacity-100': phoneNumber !== '' }" x-model="phoneNumber" class="form-input sim-input pl-5 pr-12 bg-white" wire:model="phoneNumber" type="tel" name="phone_number" placeholder="eg. 0546628393" autocomplete="off" />
                                    <div class="absolute inset-y-0 right-0 flex items-center">
                            ...
                            <div class="flex items-center">
                                ...
                                <div x-data="{ aggregator: '', hide: true }" class="inline-block relative w-full max-w-sm z-10">
                                    ...
                                    <input x-bind:class="{ 'pl-5': aggregator === '', 'pl-16 bg-gray-100 text-blue-800 opacity-100': aggregator !== '' }" x-model="aggregator" x-on:click="hide = false" class="form-input sim-select pr-12 cursor-pointer bg-white" wire:model="aggregator" type="text" name="aggregator" placeholder="Select aggregator" autocomplete="off" readonly />
                                    <div class="absolute inset-y-0 right-0 flex items-center">
                                        <svg class="w-6 h-6 text-ash-dark mr-5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                    </div>
                                    <div x-bind:class="{ 'hidden': hide === true }" x-on:click.away="hide = true" class="absolute bg-gray-100 inset-x-0 rounded-b">
    ...
    <div class="flex-none flex items-center justify-between py-8 text-ash-darkest text-xs bg-white">
        <div class="space-x-5 ml-32">
            <p class="text-black">
                &copy; 2025. Speso Technologies Limited
            </p>
        </div>
