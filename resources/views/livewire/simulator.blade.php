        ...
        <div class="flex-1 md:pr-72 lg:pr-80 xl:pr-96">
            ...
            <div class="space-y-4 md:space-y-4 pb-8 md:pb-16">
                <div class="flex flex-col md:flex-row md:items-center">
                    <label class="sim-label mb-2 md:mb-0">Host URL</label>
                    <div x-data="{ url: '{{ $url }}' }" class="inline-block relative w-full md:max-w-sm">
                ...
                <div class="flex flex-col md:flex-row md:items-center">
                    <label class="sim-label mb-2 md:mb-0">Method</label>
                    <div x-data="{ method: '{{ $method }}', hide: true }" class="inline-block relative w-full md:max-w-sm z-30">
                ...
                <div class="flex flex-col md:flex-row md:items-center">
                    <label class="sim-label mb-2 md:mb-0">Network</label>
                    <div x-data="{ network: '{{ $network }}', hide: true }" class="inline-block relative w-full md:max-w-sm z-20">
                        <div class="absolute inset-y-0 left-0 flex items-center">
                ...
                <div class="flex flex-col md:flex-row md:items-center">
                    <label class="sim-label mb-2 md:mb-0">Phone Number</label>
                    <div x-data="{ phoneNumber: '{{ $phoneNumber }}' }" class="inline-block relative w-full md:max-w-sm">
                ...
                <div class="flex flex-col md:flex-row md:items-center">
                    <label class="sim-label mb-2 md:mb-0">Aggregator</label>
                    <div x-data="{ aggregator: '{{ $aggregator }}', hide: true }" class="inline-block relative w-full md:max-w-sm z-10">
                        <div class="absolute inset-y-0 left-0 flex items-center">
            ...
            <!-- Phone Mockup - Mobile Version (Below Form) -->
            <div class="block md:hidden mt-8 mb-8">
                <div class="bg-white h-135 w-full max-w-sm mx-auto rounded-2xl px-3 pt-3 pb-8 shadow-xl">
            ...
            <!-- Phone Mockup - Desktop/Tablet Version (Absolutely Positioned) -->
            <div class="flex-none">
